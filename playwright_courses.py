...
with sync_playwright() as playwright:
    ...
    there_is_now_results = page.get_by_test_id('courses-list-empty-view-title-text')
    expect(there_is_now_results).to_be_visible()
    expect(there_is_now_results).to_have_text('There is no results')
