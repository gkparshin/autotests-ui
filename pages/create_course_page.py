...
from components.courses.create_course_exercise_form_component import CreateCourseExerciesFormComponent
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_form = CreateCourseExerciesFormComponent(page)
