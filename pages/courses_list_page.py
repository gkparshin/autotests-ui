...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.empty_new_description = page.get_by_test_id('courses-list-empty-view-description-text')
    ...
    def check_visible_course_card(self, index: int, title: str, max_score: str, min_score: str, estimated_time: str):
        ...
        expect(self.course_max_text.nth(index)).to_have_text('Max score: ' + max_score)

        expect(self.course_min_text.nth(index)).to_be_visible()
        expect(self.course_min_text.nth(index)).to_have_text('Min score: ' + min_score)

        expect(self.course_estimated_time_text.nth(index)).to_be_visible()
        expect(self.course_estimated_time_text.nth(index)).to_have_text('Estimated time: ' + estimated_time)
